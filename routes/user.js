...
router.get('/me', auth.verifyUser, (req, res, next) => {
   res.json({ _id: req.user._id, name: req.user.name,phone:req.user.phone, address: req.user.address, email:req.user.email, username: req.user.username, profileimage: req.user.profileimage,admin:req.user.admin });
